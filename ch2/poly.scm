...
(define (install-polynomial-package)
  ...
  (define (term-list-dense p)
    (apply-generic 'term-list-dense p))
  (define (term-list-sparse p)
    (apply-generic 'term-list-sparse p))
  (define (variable p)
    (apply-generic 'variable p))
  (define (add-poly p1 p2)
    (if (same-variable? (variable p1) (variable p2))
      (make-poly-from-dense (variable p1)
  ...
  (put 'make-from-sparse 'polynomial
       (lambda (v t) (tag (make-from-sparse v t))))
  (put 'make-from-dense 'polynomial
       (lambda (v t) (tag (make-from-dense v t))))
  )
...
(define (install-poly-sparse)
  ...
  (put 'term-list-dense '(sparse) term-list-sparse)
